...
const T = {
    ...
    'hero.s3': { vi: 'Đội ngũ chuyên môn', en: 'Expert team members' },
    ...
    'ab.story1': { vi: 'VietWebPro là đội ngũ gồm <span class="highlight-text">3 thành viên với hơn 10 năm kinh nghiệm</span> trong lĩnh vực thiết kế và phát triển website, với mong muốn giúp doanh nghiệp Việt có website đẹp, chuyên nghiệp mà không tốn quá nhiều chi phí.', en: 'VietWebPro is a team of <span class="highlight-text">3 members with 10+ years of experience</span> in web design and development, helping businesses get beautiful, professional websites at affordable prices.' },
    ...
    'ab.s2': { vi: 'Thành viên chuyên môn', en: 'Expert members' },
    ...
    'ab.teamT': { vi: 'Đội Ngũ Của Chúng Tôi', en: 'Our Team' },
    'ab.teamS': { vi: 'Những con người tài năng đằng sau mỗi dự án', en: 'The talented people behind every project' },
    'ab.m1': { vi: 'Thành viên 1', en: 'Member 1' },
    'ab.m1r': { vi: 'Founder & Full-stack Developer', en: 'Founder & Full-stack Developer' },
    'ab.m1d': { vi: '10+ năm kinh nghiệm phát triển web', en: '10+ years of web development experience' },
    'ab.m2': { vi: 'Thành viên 2', en: 'Member 2' },
    'ab.m2r': { vi: 'UI/UX Designer', en: 'UI/UX Designer' },
    'ab.m2d': { vi: 'Chuyên gia thiết kế giao diện web', en: 'Web interface design expert' },
    'ab.m3': { vi: 'Thành viên 3', en: 'Member 3' },
    'ab.m3r': { vi: 'Frontend Developer', en: 'Frontend Developer' },
    'ab.m3d': { vi: 'Biến thiết kế thành website sống động', en: 'Turning designs into living websites' },
